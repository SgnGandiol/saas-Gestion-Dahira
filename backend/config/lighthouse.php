...
return [
    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
            ...
            // Rate limiting: 60 requests/minute globally, 10/minute on auth mutations
            'throttle:graphql',
    ...
    */
    ...
    'security' => [
        'max_query_complexity' => env('LIGHTHOUSE_MAX_QUERY_COMPLEXITY', GraphQL\Validator\Rules\QueryComplexity::DISABLED),
    ...
    */
    ...
    'debug' => env('LIGHTHOUSE_DEBUG', env('APP_ENV') === 'local'
